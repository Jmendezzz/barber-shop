...
const clients: Array<Client> = [
    {
        ...
        opinion: "¡La Barbería de Gerard es simplemente excepcional! Cada vez que entro, me siento transportado a la época dorada de la barbería. Los barberos son verdaderos artistas, dominan a la perfección los cortes clásicos y siempre logran que me vea elegante y sofisticado. ¡No puedo recomendarlos lo suficiente!"
      },
      {
        image: "ruta-de-la-imagen",
        fullName: "Carlos Ramírez",
        opinion: "Si buscas una experiencia de barbería auténtica, no puedes dejar de visitar la Barbería de Gerard. Sus sedes son como oasis de tradición en medio de la modernidad. Cada detalle, desde la música hasta el aroma a cuero, te hace sentir como si estuvieras en otra época. Los barberos son verdaderos maestros y siempre me sorprenden con cortes de cabello impecables. ¡Sin duda, la mejor barbería en la ciudad!"
      },
      {
        image: "ruta-de-la-imagen",
        fullName: "",
        opinion: "La Barbería de Gerard es mi lugar favorito para obtener un corte de cabello clásico y elegante. La atención al detalle es incomparable, desde el trato amable hasta los productos de alta calidad que utilizan. Cada vez que salgo de allí, me siento rejuvenecido y con una confianza renovada. Definitivamente, recomiendo a todos aquellos que busquen un estilo tradicional y una experiencia única."
      }
