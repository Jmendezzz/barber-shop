        ...
        <section className="w-[70%]">
          <section>
            ...
            <p className="text-xl font-serif ">
              Descubre el arte del cuidado personal con nosotros. Fundada en
              2021 por Juan Gerardo, nuestra pasión por la barbería se ha
              convertido en un proyecto profesional que combina habilidad e
              innovación.
            </p>
          </section>
          <br />
          <section>
            ...
            <p className="text-xl font-serif ">
              En 2021, Juan Gerardo comenzó a perfeccionar su arte con
              familiares y amigos. Para 2022, sus habilidades se refinaron, y
              vio el potencial de crear una experiencia única en la barbería.
            </p>
          </section>
          <br />
          <section>
